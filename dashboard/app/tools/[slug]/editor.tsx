      ...
      <div className="space-y-5 px-5 py-5">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Cualquier modelo disponible en OpenRouter. Ej:{" "}
            <span className="font-mono">google/gemini-2.5-flash</span>,{" "}
            <span className="font-mono">openai/gpt-5-mini</span>,{" "}
            <span className="font-mono">openai/whisper-large-v3-turbo</span>.
          </p>
        </div>
